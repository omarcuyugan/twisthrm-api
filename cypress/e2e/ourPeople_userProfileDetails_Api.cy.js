{
    describe('Our People User Profile Details, As an HR Personnel API', () => {
        ...
        it('Should not be able to fetch user by passing invalid Employee number', () => {
        ...
        it('I should be able to edit the editable fields ', { tags: ['@smoke','@coreRegression']},() => {
    ...
    describe('Our People User Profile Details, As an Employee API', () => {
        ...
        it('I should be able to edit my information with the editable fields', { tags: ['@smoke','@coreRegression']}, () => {
